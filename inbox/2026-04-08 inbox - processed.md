...
# Import: 2026-04-08 inbox

Processing file for [[2026-04-08 inbox]].

## Already in backlog (skip or link)

| source line | existing item | notes |
|---|---|---|
| "Almost there" on home screen, recs for single-level skills | #40 Review recommendations logic and language | exact duplicate |
| RT depends on context, speed check per button set | #44 Speed check per input type | exact duplicate |
| "Review in 1d" label, consolidate logic | #40 Review recommendations logic and language | fold into existing |
| Rework "I know / skip", level edit mode | #25 Level card actions UX: improve known/skip | overlaps, add note |
| Desktop nav should be on top | #30 Web: nav should be on top | exact duplicate |
...
|---|---|---|---|---|---|---|
| C1 | Show progress in skill: RT over time or reps/round | 🛠️ | ❗❗ | | | user feedback request |
...
- **Create**: 19 new items (A1–A9, B1–B2, C1, D1–D3, E1–E4)
- **Skip/duplicate**: 5 already in backlog, 3 session tasks
- **Merge candidates**: 2
